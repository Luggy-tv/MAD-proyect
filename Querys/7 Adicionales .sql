...
EXEC sp_GestionarUsuario @op='i',@IDUsuario	=10000 ,@contraseña	='Marinas117', @nombres='Luis Alfonso', @apellidoPat='Martinez',@apellidoMat='Martinez',@CURP='MAML000123HNLRRSA7', @fechNac='2000-01-23', @numNomina='9364867774537734'		, @email='luis@mail.com'		, @esAdmin=1

EXEC sp_GestionarUnidadDeMedida @op ='i',@IDUnidadMedida=10,@nombre='Kilo',@Descripcion ='Unidad de masa del sistema internacional.'
EXEC sp_GestionarUnidadDeMedida @op ='i',@IDUnidadMedida=11,@nombre='Gramo',@Descripcion ='Unidad de masa, milésima parte de un kilogramo.'
...
EXEC sp_GestionarUnidadDeMedida @op ='i',@IDUnidadMedida=13,@nombre='Litro',@Descripcion ='Unidad de volumen del Sistema Internacional,ue equivale a 1 decímetro cúbico.'
EXEC sp_GestionarUnidadDeMedida @op ='i',@IDUnidadMedida=14,@nombre='Mililitro',@Descripcion ='Unidad de volumen, la milésima parte de un litro.'
